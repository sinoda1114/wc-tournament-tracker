...
### 🟢 着手可（設計確定）
- **T-43** みんなの投票のライフサイクル設計＋実装（**方針確定6/12**）。詳細は下。
