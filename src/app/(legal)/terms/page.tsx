 ...
 *
 * 【残プレースホルダ】info@matchfav.com（事業用メールアドレス確定後に置換）。
 *   価格は確定（金額は特商法表記に一元化）。
 */
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          <li>
            ...
            （金額は<Link href="/tokushoho">特定商取引法に基づく表記</Link>に明示します）を
            一度支払うことにより、本大会終了に伴うサービス提供終了時まで本サービスを
            利用できます。月額・年額等の継続課金（サブスクリプション）ではありません。
          </li>
          <li>
            本大会のグループステージ期間（2026年6月27日（日本時間）の同ステージ最終戦終了まで）は、
            すべての登録利用者が無料で本サービスを利用できます。決勝トーナメント期間
            （2026年6月28日以降）の利用には、前号の料金の支払いが必要です（以上を総称して
            以下「無料期間」）。
          </li>
          <li>
            前号にかかわらず、2026年6月28日以降に新たにアカウント登録を完了した利用者は、
            登録完了時から<strong>72時間</strong>に限り、無料で本サービスを利用できます。
          </li>
          <li>
