 ...
 *  - グループステージ（〜6/27 JST）は全登録者無料。
 *  - 決勝トーナメント（R32 = 6/28 JST〜）から買い切り課金。
...
/**
 * 決勝トーナメント開始＝課金開始の境界。2026-06-28 00:00（日本時間, JST=UTC+9）。
 * UTC では 2026-06-27T15:00:00Z。この瞬間より前が「無料期間」。
 * ISO 文字列で定義し、月の 0-index 誤読を避ける（テストでも値を固定検証）。
 */
export const KNOCKOUT_START_UTC = new Date('2026-06-27T15:00:00Z').getTime();
