...
export const ja = {
  ...
  home: {
    ...
    heroTitle: 'W杯2026のすべてを、この1画面で。',
    heroTagline: '「今日、誰が勝った？」に最速で答える、ファンが作った非公式トラッカー。広告だらけの巨大サイトに疲れた人のために、軽く・シンプルに作りました。',
    heroPoint1: '全試合の日程・結果・順位・トーナメント表を1画面で',
    heroPoint2: 'お気に入りチームを登録して、自分仕様の大会に',
    heroPoint3: 'みんなで優勝予想。会場の天気もチェック',
    heroLead: 'グループステージはログインするだけで、ずっと無料。',
    heroCta: '無料で始める',
  },
