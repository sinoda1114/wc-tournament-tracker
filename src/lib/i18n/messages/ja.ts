...
export const ja = {
  ...
  home: {
    ...
    heroTagline: '史上初、アメリカ・カナダ・メキシコの3か国共催。「この試合、どの国のどのスタジアム？」が分かりにくい大会だからこそ、日程・結果・順位・会場・出場選手の散らばった情報をひとつにまとめました。ファンによる非公式トラッカーです。',
  ...
  footer: {
    brandTitle: 'MatchFav — W杯2026の「見たい」を、ぜんぶ1か所に（非公式ファンサイト）',
    brandDesc:
