...
export const zh: Dictionary = {
  meta: {
    home: {
      title: 'MatchFav — 2026足球 赛程、比分与夺冠预测（非官方）',
      description:
  ...
  home: {
    ...
    heroTitle: '谁出战、在哪里、何时开赛？2026世界杯一目了然。',
    heroTagline: '史上首次由美国、加拿大、墨西哥三国联合主办。参赛球队增至48支，比赛和球场比以往更多，也更难理清。MatchFav将赛程、比分、积分榜、球场和参赛球队整合在一起，让你几秒钟就能找到想看的比赛。',
    heroPoint1: '收藏喜爱的球队，直达你最关心的比赛',
    heroPoint2: '从国家到城市再到球场，场馆信息一屏看全',
    heroPoint3: '从小组赛到淘汰赛，赛程脉络一路跟进',
    heroPoint4: '用夺冠概率和大家的预测，畅享冠军悬念',
    heroLead: '小组赛阶段免费畅享。',
    heroCta: '登录开始',
  },
  tournament: {
