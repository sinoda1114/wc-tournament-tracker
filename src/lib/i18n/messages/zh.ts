...
export const zh: Dictionary = {
  ...
  home: {
    ...
    heroTitle: '2026世界杯的一切，尽在一屏。',
    heroTagline: '由球迷为球迷打造的非官方追踪器——最快回答"今天谁赢了？"。轻量、简洁，献给厌倦了广告泛滥的大型网站的你。',
    heroPoint1: '全部比赛的赛程、比分、积分榜与对阵图，一屏全览',
    heroPoint2: '收藏喜爱的球队，打造属于你的世界杯',
    heroPoint3: '和大家一起预测冠军，还能查看球场天气',
    heroLead: '小组赛阶段免费，登录即可使用。',
    heroCta: '免费开始',
  },
  tournament: {
    viewLabel: '视图',
