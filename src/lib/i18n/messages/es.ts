...
export const es: Dictionary = {
  ...
  rankings: {
    ...
    historicalNoteLive: 'Los goles en verde son del Mundial 2026.',
  ...
  prediction: {
    ...
    fifaRankFreshness: 'ⓘ Ranking FIFA: actualizado con resultados de WC2026 (próxima actualización oficial: 20 de julio de 2026)',
